...
class Plan
{
    ...
    public static function create(array $data): int
    {
        ...
        $stmt = $pdo->prepare('INSERT INTO plans (
                ...
                allow_marketing_calendar,
                allow_marketing_calendar_sharing,
        ...
        $stmt->execute([
            ...
            'allow_marketing_calendar' => (int)($data['allow_marketing_calendar'] ?? 0),
            'allow_marketing_calendar_sharing' => (int)($data['allow_marketing_calendar_sharing'] ?? 0),
    ...
    public static function updateById(int $id, array $data): void
    {
        ...
        $stmt = $pdo->prepare('UPDATE plans SET
            ...
            allow_marketing_calendar = :allow_marketing_calendar,
            allow_marketing_calendar_sharing = :allow_marketing_calendar_sharing,
