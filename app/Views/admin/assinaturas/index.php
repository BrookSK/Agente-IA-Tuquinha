...
<div style="max-width: 1000px; margin: 0 auto;">
    ...
    <form method="get" action="/admin/assinaturas" style="margin-bottom: 14px; display:flex; gap:8px; align-items:center;">
        <label style="font-size:13px; color:#b0b0b0;">Filtrar por status:</label>
        <select name="status" style="min-width:140px; padding:6px 10px; border-radius:999px; border:1px solid #272727; background:#050509; color:#f5f5f5; font-size:13px;">
    ...
    <table style="width:100%; border-collapse:collapse; font-size:13px; background:#111118; border-radius:12px; overflow:hidden; border:1px solid #272727;">
        ...
        <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding:7px 10px;">
                            ...
                            <?php if (!empty($s['plan_slug'])): ?>
                                <span style="font-size:11px; color:#b0b0b0;">(<?= htmlspecialchars($s['plan_slug']) ?>)</span>
                            <?php endif; ?>
                        </td>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="5" style="padding:10px; color:#b0b0b0;">Nenhuma assinatura encontrada.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
