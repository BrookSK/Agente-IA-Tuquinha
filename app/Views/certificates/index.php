    ...
    <?php else: ?>
        <div style="display:flex; flex-direction:column; gap:10px;">
            <?php foreach ($items as $it): ?>
                ...
                ?>
                <div style="border-radius:14px; border:1px solid var(--border-subtle); background:var(--surface-card); padding:12px 12px; display:flex; gap:12px; align-items:center;">
