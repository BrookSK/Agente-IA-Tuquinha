...
(function () {
    ...
    function startSse() {
        try {
            ...
            sse = new EventSource('/painel-externo/chat/stream?conversation_id=' + encodeURIComponent(conversationId) + '&last_id=' + encodeURIComponent(lastMessageId));
    ...
    function sendSignal(kind, payload) {
        ...
        return fetch('/painel-externo/webrtc/send', {
            method: 'POST',
            body: fd,
    ...
    function pollSignals() {
        ...
        fetch('/painel-externo/webrtc/poll?conversation_id=' + encodeURIComponent(conversationId) + '&since_id=' + encodeURIComponent(webrtcSinceId), {
            headers: { 'X-Requested-With': 'XMLHttpRequest' }
        }).then(function (r) {
            return r.json();
        }).then(function (data) {
